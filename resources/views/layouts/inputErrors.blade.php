...
<input class="shadow appearance-none border text-gray-700 rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="{{$check}}" name="{{$check}}" type="text" placeholder="{{$label}}">
